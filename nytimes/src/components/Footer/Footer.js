            ...
            <Container >
                <Card>
                    <CardBody>
                        ...
                        <a href="https://github.com/codingbc/nytreact" target="_blank" rel="noopener noreferrer" className="footer-button">
                            <Button size="lg">GitHub Repo</Button>
                        </a>
                        <a href="https://www.linkedin.com/in/nadiah-nida-2b016529/" target="_blank" rel="noopener noreferrer" className="footer-button btn-lg">
